...
parser.add_argument('--batchSize', default=256,
                    help='Batch size',
                    type=int)
parser.add_argument('--validBatchSize', default=256,
...
parser.add_argument('--validFreq', default=39,
                    help='Number of batches in between validation steps',
                    type=int)
parser.add_argument('--saveFreq', default=39,
                    help='Number of batches in between model savings.',
                    type=int)
parser.add_argument('--sampleFreq', default=39,
                    help='Generate some samples in between sampleFreqs updates.',
                    type=int)
